...
import type { UserProfile, PublicProfile, ProfileUpdateBody } from "../types/profile";
...
export const api = createApi({
  ...
  tagTypes: ["Assignments", "Assignment", "AdminUsers", "AdminAudit", "Profile"],
  ...
  endpoints: (builder) => ({
    ...
    updateMyProfile: builder.mutation<{ profile: UserProfile }, ProfileUpdateBody>({
